...
import com.hiking.humusicplayer.bean.AlbumInfo;
import com.hiking.humusicplayer.bean.ArtistInfo;
import com.hiking.humusicplayer.bean.FolderInfo;
...
public class MusicUtil implements IConstant{
    ...
    private static String[] proj_album = new String[]{Albums._ID, MediaStore.Audio.Albums.ALBUM_ART,
    ...
    public static List<FolderInfo> queryFolder(Context context) {
        ...
        StringBuilder mSelection = new StringBuilder(FileColumns.MEDIA_TYPE
                ...
                + FileColumns.DATA + " like'%.mp3' or " + MediaStore.Audio.Media.DATA
                + " like'%.wma')");
