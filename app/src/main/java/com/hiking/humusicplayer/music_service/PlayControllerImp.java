...
public class PlayControllerImp {

    private static final String TAG = "PlayControllerImp";

    private final Context context;
    private static volatile PlayControllerImp MANAGER = null;
    ...
    private PlayControllerImp(Context context, AudioFocusManager focusManager, MediaSessionManager sessionManager, NotifyStatusChanged sl, NotifySongChanged sc, NotifyPlayListChanged pl) {
    ...
    public static PlayControllerImp getMediaController(Context context, AudioFocusManager focusManager, MediaSessionManager sessionManager, NotifyStatusChanged sl, NotifySongChanged sc, NotifyPlayListChanged pl) {
        if (MANAGER == null) {
            synchronized (PlayControllerImp.class) {
                if (MANAGER == null)
                    MANAGER = new PlayControllerImp(context, focusManager, sessionManager, sl, sc, pl);
            }
        }
        return MANAGER;
    }
